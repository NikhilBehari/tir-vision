...
# print("started")
# start_t = time.time()
# analysis_test1 = ObjectCrop(out_folder='../output/', img_label='0000000367_0000000000')
# # analysis_test1.grid_options(8)
# analysis_test1.deconstruct(40, 54, 8, iou_thresh=0.2, test_run=False)
# print("Done in %s" % (time.time() - start_t))
#
#
